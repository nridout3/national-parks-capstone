...
let select = document.getElementById('selectLocation');
    ...
    nationalParksArray.forEach((product, index) => {
        console.log(product.LocationName);
     });
        
        
        let properties = parkInfo.length;
             for(let i = 0; i < properties; i++){
               // console.log(parkInfo[i]);
             }
             if (locationsArray == nationalParksArray){
             ...
             function bulidParkInfo(nationalParksArray) {
                 return nationalParksArray.LocationName + " " + nationalParksArray.State;
               }
                 let parkInfo = nationalParksArray.map(bulidParkInfo);
    ...
    //     if (a.LocationName <b.Fax) return -1;
    //     else if (a.LocationName == b.Fax) return 0;
    //     else return 1;
    //    // console.log(nationalParksArray[i].LocationName);
